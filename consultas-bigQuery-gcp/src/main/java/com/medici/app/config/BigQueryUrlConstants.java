...
public class BigQueryUrlConstants {
    ...
    private static final String GET_BY_CONGENITAL_ABNORMALITIES = "SELECT * FROM `bigquery-public-data.sdoh_cdc_wonder_natality.county_natality_by_congenital_abnormalities` LIMIT 3174";
}
